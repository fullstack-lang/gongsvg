...
func rectangleInjection(stage *models.StageStruct) {
	...
	__Link__000001_Second_Arrow := (&models.Link{Name: `Second Arrow`}).Stage(stage)
...
Line 2`}).Stage(stage)
	...
	// Link values setup
	__Link__000001_Second_Arrow.Name = `Second Arrow`
	__Link__000001_Second_Arrow.Type = models.LINK_TYPE_FLOATING_ORTHOGONAL
	__Link__000001_Second_Arrow.StartAnchorType = models.ANCHOR_BOTTOM
	__Link__000001_Second_Arrow.EndAnchorType = models.ANCHOR_LEFT
	__Link__000001_Second_Arrow.StartOrientation = models.ORIENTATION_VERTICAL
	__Link__000001_Second_Arrow.StartRatio = 0.318038
	__Link__000001_Second_Arrow.EndOrientation = models.ORIENTATION_HORIZONTAL
	__Link__000001_Second_Arrow.EndRatio = 0.827103
	__Link__000001_Second_Arrow.CornerOffsetRatio = 1.008197
	__Link__000001_Second_Arrow.CornerRadius = 0.000000
	__Link__000001_Second_Arrow.HasEndArrow = true
	__Link__000001_Second_Arrow.EndArrowSize = 15.000000
	__Link__000001_Second_Arrow.Color = ``
	__Link__000001_Second_Arrow.FillOpacity = 0.000000
	__Link__000001_Second_Arrow.Stroke = `red`
	__Link__000001_Second_Arrow.StrokeWidth = 4.000000
	__Link__000001_Second_Arrow.StrokeDashArray = ``
	__Link__000001_Second_Arrow.StrokeDashArrayWhenSelected = ``
	__Link__000001_Second_Arrow.Transform = ``
...
line 3`
	...
	__Layer__000002_Link_layer_vertical_to_horizontal.Links = append(__Layer__000002_Link_layer_vertical_to_horizontal.Links, __Link__000001_Second_Arrow)
	...
	__Link__000001_Second_Arrow.Start = __Rect__000000_Bottom
	__Link__000001_Second_Arrow.End = __Rect__000002_Top
