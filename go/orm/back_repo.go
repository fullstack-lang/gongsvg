...
func (backRepo *BackRepoStruct) init(stage *models.StageStruct, db *gorm.DB) {
	// insertion point for per struct back repo declarations
	backRepo.BackRepoAnimate.Init(stage, db)
	backRepo.BackRepoCircle.Init(stage, db)
	backRepo.BackRepoEllipse.Init(stage, db)
	backRepo.BackRepoLine.Init(stage, db)
	backRepo.BackRepoPath.Init(stage, db)
	backRepo.BackRepoPolygone.Init(stage, db)
	backRepo.BackRepoPolyline.Init(stage, db)
	backRepo.BackRepoRect.Init(stage, db)
	backRepo.BackRepoSVG.Init(stage, db)
	backRepo.BackRepoText.Init(stage, db)
