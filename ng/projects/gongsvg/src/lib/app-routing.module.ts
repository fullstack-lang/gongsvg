...
const routes: Routes = [ // insertion point for routes declarations
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-circle-adder/:id/:association', component: CircleDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-ellipse-adder/:id/:association', component: EllipseDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-line-adder/:id/:association', component: LineDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-path-adder/:id/:association', component: PathDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-polygone-adder/:id/:association', component: PolygoneDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-polyline-adder/:id/:association', component: PolylineDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-rect-adder/:id/:association', component: RectDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-svg-adder/:id/:association', component: SVGDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
	...
	{ path: 'github_com_fullstack_lang_gongsvg_go-text-adder/:id/:association', component: TextDetailComponent, outlet: 'github_com_fullstack_lang_gongsvg_go_editor' },
